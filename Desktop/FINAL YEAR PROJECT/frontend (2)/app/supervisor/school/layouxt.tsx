...
interface SchoolSupervisorLayoutProps {
  children: React.ReactNode;
}

const SchoolSupervisorLayout: React.FC<SchoolSupervisorLayoutProps> = ({
  children,
}) => {
  ...
  const navigationItems = [
    {
      name: "Dashboard",
      href: "/supervisor/school",
      icon: LayoutDashboard,
    },
    {
      name: "Student Logbooks",
      href: "/supervisor/school/logbooks",
      icon: BookOpen,
    },
  ];
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200 space-y-2">
            <Link
              href="/school-supervisor/settings"
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-4 py-4 flex items-center justify-between lg:px-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">School Supervisor</p>
            </div>
          </div>
        </header>
...
export default SchoolSupervisorLayout;
